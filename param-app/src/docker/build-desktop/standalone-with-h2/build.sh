...
docker run -it --rm \
    ...
    -c "mvn --batch-mode -pl '!param-app-cucumber' install -DskipTests; cp /usr/src/mymaven/param-app/src/docker/build-desktop/standalone-with-h2/* /usr/src/mymaven/param-app/target"
